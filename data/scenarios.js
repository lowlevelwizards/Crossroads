...
const mokra = Object.freeze({
  ...
  terrain:freezeList([
    ...
    {id:"north-road",terrainId:"road_straight",x:19,y:7.2,width:23,height:3.2},
    {id:"central-road-west",terrainId:"road_straight",x:0,y:22,width:42,height:3.8},
    {id:"central-road-east",terrainId:"road_straight",x:45,y:22,width:27,height:3.8},
    {id:"south-road-west",terrainId:"road_straight",x:17,y:36,width:25,height:3.2},
    {id:"south-road-east",terrainId:"road_straight",x:45,y:36,width:21,height:3.2},
    {id:"east-road",terrainId:"road_straight",x:61,y:24,width:3.4,height:22},

    {id:"north-dense-wood",terrainId:"woods_dense",x:18,y:1,width:18,height:12,variant:3},
    {id:"north-orchard",terrainId:"orchard",x:4,y:2,width:11,height:10},
    {id:"south-dense-wood",terrainId:"woods_dense",x:1,y:31,width:16,height:15,variant:2},
    {id:"south-wood",terrainId:"woods",x:13,y:37,width:12,height:9,variant:1},
    {id:"reserve-wood",terrainId:"woods",x:54,y:8,width:15,height:14,variant:4},

    {id:"stream-west",terrainId:"stream",x:0,y:28.5,width:23,height:2.8},
    {id:"ditch-center",terrainId:"ditch",x:22,y:29.2,width:18,height:2.5},
    {id:"stream-east",terrainId:"stream",x:45,y:29.5,width:20,height:2.8},

    {id:"village-church",terrainId:"church",appearance:"wooden_brown_red",x:6,y:14,width:9,height:8},
    {id:"village-farmhouse",terrainId:"long_farmhouse",appearance:"mixed_plaster_red",x:16,y:17,width:12,height:6.5},
    {id:"village-cottage-a",terrainId:"medium_cottage",appearance:"peach_plaster_red",x:28,y:14,width:8,height:6.5},
    {id:"village-cottage-b",terrainId:"small_cottage",appearance:"whitewash_red",x:11,y:24,width:7,height:6},
    {id:"village-cottage-c",terrainId:"small_cottage",appearance:"log_thatch",x:29,y:24,width:7,height:6},
    {id:"village-barn",terrainId:"barn",appearance:"weathered_charcoal",x:20,y:25,width:9,height:6.5},
    {id:"village-shed",terrainId:"shed",appearance:"timber_brown",x:34,y:17,width:6,height:5},
    {id:"reserve-farm",terrainId:"medium_cottage",appearance:"concrete_thatch",x:51,y:32,width:9,height:7},
    ...
    {id:"hedge-north-a",terrainId:"hedge",x:4,y:12,width:12,height:1.8},
    {id:"hedge-north-b",terrainId:"hedge",x:23,y:13,width:12,height:1.8},
    {id:"hedge-center-a",terrainId:"hedge",x:4,y:27,width:13,height:1.8},
    {id:"hedge-center-b",terrainId:"hedge",x:27,y:31.5,width:12,height:1.8},
    {id:"hedge-east",terrainId:"hedge",x:49,y:27,width:12,height:1.8},
    {id:"fence-village-a",terrainId:"fence_wood",x:7,y:31,width:12,height:1.6},
    {id:"fence-village-b",terrainId:"fence_wood",x:24,y:11,width:10,height:1.6},
    {id:"wall-village",terrainId:"wall",x:28,y:21,width:10,height:1.8},
    {id:"wall-reserve",terrainId:"wall",x:50,y:40,width:11,height:1.8},
    {id:"haystack",terrainId:"haystack",x:25,y:35,width:4,height:4},
    {id:"woodpile",terrainId:"woodpile",x:18,y:14,width:4,height:3}
  ]),
  ...
  forces:Object.freeze({
    blue:freezeList([
      {id:"mokra-blue-rifle-a",name:"1st Mounted Rifle Squadron",unitType:"rifleSquad",quality:"veteran",x:34,y:9,deploymentZone:"forward"},
      {id:"mokra-blue-rifle-b",name:"2nd Mounted Rifle Squadron",unitType:"rifleSquad",quality:"veteran",x:35,y:23,deploymentZone:"forward"},
      {id:"mokra-blue-rifle-c",name:"3rd Mounted Rifle Squadron",unitType:"rifleSquad",quality:"regular",x:34,y:39,deploymentZone:"forward"},
      {id:"mokra-blue-mmg",name:"Heavy Machine-Gun Section",unitType:"mmgTeam",quality:"regular",x:37,y:20,deploymentZone:"forward"},
      {id:"mokra-blue-officer",name:"Regimental Command",unitType:"officer",quality:"veteran",x:52,y:27,deploymentZone:"reserve"},
      {id:"mokra-blue-reserve",name:"Reserve Squadron",unitType:"assaultSquad",quality:"regular",x:55,y:36,deploymentZone:"reserve"}
    ]),
    red:freezeList([
      {id:"mokra-red-officer",name:"German Battle Group HQ",unitType:"officer",quality:"regular",x:6,y:6,deploymentZone:"attack"},
      {id:"mokra-red-rifle-a",name:"Northern Rifle Platoon",unitType:"rifleSquad",quality:"regular",x:7,y:14,deploymentZone:"attack"},
      {id:"mokra-red-rifle-b",name:"Central Rifle Platoon",unitType:"rifleSquad",quality:"regular",x:7,y:22,deploymentZone:"attack"},
      {id:"mokra-red-rifle-c",name:"Southern Rifle Platoon",unitType:"rifleSquad",quality:"regular",x:7,y:31,deploymentZone:"attack"},
      {id:"mokra-red-assault",name:"Assault Detachment",unitType:"assaultSquad",quality:"veteran",x:7,y:39,deploymentZone:"attack"},
