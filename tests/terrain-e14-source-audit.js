...
assert(buildInfo.includes('version: "S1.1.1"'), "build metadata must identify Viewport & Interaction Reliability S1.1.1");
assert(buildInfo.includes('codename: "Viewport & Interaction Reliability"'), "build codename must match the release");
