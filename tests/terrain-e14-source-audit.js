...
assert(buildInfo.includes('version: "S1.0"'), "build metadata must identify Scenario Runtime S1.0");
assert(buildInfo.includes('codename: "Objective Foundation"'), "build codename must match the release");
